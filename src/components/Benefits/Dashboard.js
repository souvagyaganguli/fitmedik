                ...
                <div className="container">
                    ...
                    <div className="row pt-2 pt-md-3 pt-lg-4">
                        <div className="col-12 col-lg-4 mb-4 mb-lg-0">
                            <h4 style={{fontWeight: "600"}}><span style={{color: "#F55F4B"}}>01.</span> Massa facilisi</h4>
                            <h5 className="txt-body pt-2 pt-lg-3 lh-base">Lorem varius tincidunt orci, quis leo magna gravida vel dictum. Ultrices sed.</h5>
                        </div>
                        <div className="col-12 col-lg-4 mb-4 mb-lg-0">
                            <h4 style={{fontWeight: "600"}}><span style={{color: "#F55F4B"}}>02.</span> Et scelerisque</h4>
                            <h5 className="txt-body pt-2 pt-lg-3 lh-base">Lorem varius tincidunt orci, quis leo magna gravida vel dictum. Ultrices sed.</h5>
                        </div>
                        <div className="col-12 col-lg-4 mb-4 mb-lg-0">
                            <h4 style={{fontWeight: "600"}}><span style={{color: "#F55F4B"}}>03.</span> Sed aliquet</h4>
                            <h5 className="txt-body pt-2 pt-lg-3 lh-base">Lorem varius tincidunt orci, quis leo magna gravida vel dictum. Ultrices sed.</h5>
                        </div>
