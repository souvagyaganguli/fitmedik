        ...
        return (
            ...
            <div className="content" id="appscreen">
                <div className="div-text1">
                    ...
                    <h5 className="txt-body text-white pt-4 lh-base">Fitmedik ensures your health and well being of healthcare workers through a tailor-made mobile app which monitors their heart rate and sleep cycles through a wearable. </h5>
                    </div>
                    <div className="div-text2">
                    <h1 className="display-2 cus-d2 text-white" style={{fontWeight: "600"}}>Monitor vulnerabilities</h1>
                    <h5 className="txt-body text-white pt-4 lh-base">Fitmedik make healthcare workers aware about how vulnerable their health profile is to a certain disease through various Artificial Intelligence and Machine Learning Algorithms. </h5>
                    </div>
                    <div className="div-text2">
                    <h1 className="display-2 cus-d2 text-white" style={{fontWeight: "600"}}>On-demand access to care</h1>
                    <h5 className="txt-body text-white pt-4 lh-base">Fitmedik provides access to best Mental health and well being experts to the healthcare workers. Through anonymity and confidentiality, we break the barriers which medics face as patients. </h5>
                    </div>
